...
3. **License** — orchestration stays MIT. Do not vendor Chromium or AGPL Lightpanda source into this tree.
4. **CDP** — keep default bind on loopback (`127.0.0.1`).
5. **No binaries** — do not commit browser binaries; use `wick install-engine` (Playwright Chromium).
